...
export function RecordSheet({
  ...
  return (
    ...
    >
      <SheetMotionStyles />
      <div className="relative flex flex-col gap-1.5 border-b border-line bg-surface px-4 py-2 sm:gap-2.5 sm:px-5 sm:py-3.5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <h2 className="font-serif text-[17px] font-semibold text-ink max-sm:sr-only">Record sheet</h2>
            <div className="h-[18px] overflow-hidden text-[12.5px] sm:mt-0.5" aria-live="polite">
              {live ? (
          ...
          <div className="flex shrink-0 items-center gap-2.5 max-sm:hidden">
